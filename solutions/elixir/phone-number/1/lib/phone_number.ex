defmodule PhoneNumber do
  ...
  defp validate(<<"1", area::binary-size(3), exchange::binary-size(3), subscriber::binary-size(4)>> = number) do
    validate(area <> exchange <> subscriber)
  end
  ...
  defp validate(<<area::binary-size(3), exchange::binary-size(3), subscriber::binary-size(4)>> = number) do
    cond do
